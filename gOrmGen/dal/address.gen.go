...
type IAddressDo interface {
	...
	FilterWithId(id int) (result []model.Address, err error)
}

// SELECT * FROM @@table WHERE id = @id{{end}}
func (a addressDo) FilterWithId(id int) (result []model.Address, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM address WHERE id = ? ")
